...
type Env = {
  ...
  WITHDRAWAL_MIN_USD_CENTS: number;
  WITHDRAWAL_MAX_USD_CENTS: number;
  WITHDRAWAL_DAILY_LIMIT_USD_CENTS: number;
...
export const env: Env = {
  ...
  WITHDRAWAL_MIN_USD_CENTS: getEnvNumber("WITHDRAWAL_MIN_USD_CENTS", 1000),
  WITHDRAWAL_MAX_USD_CENTS: getEnvNumber("WITHDRAWAL_MAX_USD_CENTS", 0),
  WITHDRAWAL_DAILY_LIMIT_USD_CENTS: getEnvNumber("WITHDRAWAL_DAILY_LIMIT_USD_CENTS", 0),
  WITHDRAWAL_REQUIRES_2FA: getEnvBoolean("WITHDRAWAL_REQUIRES_2FA", true),
};
